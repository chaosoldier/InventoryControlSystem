...
import jp.isakmp2spring.booklist.domain.common.exception.ResourceNotFoundException;
import jp.isakmp2spring.booklist.domain.model.User;
import jp.isakmp2spring.booklist.domain.repository.user.UserRepository;
